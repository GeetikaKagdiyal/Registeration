...
<label class="col-md-3 control-label">Enter firstname whose record you want to delete</label>
<input name="fname" class="form-control" type="text">

<div class="form-group">
					<label class="col-md-3 control-label"></label>
					<div class="col-md-8">
<input type="submit" style="width: 90px;" class="btn btn-success" value="Delete" />
</div></div>
