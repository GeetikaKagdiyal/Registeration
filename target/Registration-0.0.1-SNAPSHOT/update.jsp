...
<header style="background-color: silver;">
	<div class="wrapper">
		<h1>Update<span class="color">.</span></h1>
		<span>
			<ul>
...
%><div style="background-color: silver;" class="table-responsive">
			...
			<h3>Enter firstname whose record you want to update</h3>
...
<div class="form-group">
					<label class="col-md-3 control-label"></label>
					<div class="col-md-8">
<input type="submit" style="width: 90px;" class="btn btn-success" value="Update" />
</div></div>
